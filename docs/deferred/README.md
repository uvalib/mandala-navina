...
| [d11-dev-database-bootstrap-and-migration-source.md](d11-dev-database-bootstrap-and-migration-source.md) | deployment / database / migration / dev environment | Session 2026-07-15 (1b.1 part 4) | High — **DECIDED 2026-07-16** (A/B/C); `deploy_install.yml` impl deferred to a terraform-infra driver; dev serves /core/install.php until bootstrapped |
