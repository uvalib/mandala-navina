...
AV14 and AV16 done (see the [AV2 scope note](../planning/av-content-type-decision.md), the
...
**What can proceed solo in the meantime**: AV15's metadata modal and AV13 (player
preset data population) — both independently scoped, neither touching Group access or
uploads. AV4's live
