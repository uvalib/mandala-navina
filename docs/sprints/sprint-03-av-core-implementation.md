...
corpus migrates and is verified locally (PR #193, ready for review). **The upload track
(AV11 → AV12) is deferred as of 2026-09-15 until Than is back (week of 2026-09-22)** — a
capacity/sequencing call, same pattern as Texts/Sources' earlier pause, not a technical
blocker. **Two independent tracks can proceed in the meantime**: access/display
(AV7's two remaining realms, AV9's gallery UI, AV15's metadata modal) and AV13 (player
preset data population, benefits AV9 regardless of the upload track's status). AV4's live
