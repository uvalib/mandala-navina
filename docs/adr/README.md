...
| [015](015-editorial-access-model-global-content-editor.md) | D11 editorial access model: global non-admin `content_editor` (shanti_editor equivalent), assigned only to former shanti_editors; per-group editors deferred to Group roles | Proposed |
